...
define('G5_ADMIN_PC_R', G5_URL.'/'.G5_ADMIN_DIR.'/Partner_Center/myrecipe_main.php');
define('GS_PC_ADMIN_URL', G5_URL.'/myrecipe_main.php');
...
define('G5_NAIL25_DIR', 'nail25');
define('G5_NAIL25_URL',   G5_URL.'/mobile/'.G5_NAIL25_DIR);
?>