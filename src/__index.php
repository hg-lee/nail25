...
<div class="sidx">
    <section id="anc_sidx_ord">
        <h2>레시피 리스트</h2>
        <?
        $recipe_list=get_myrecipe_list($member['mb_no']);
        //echo "<pre>";
        //print_r($recipe_list);
        $progress_img=0;
        ...
        <div style="width:100%;">
            <div style="width:80%;max-width:600px;float:left;margin-bottom: 20px;padding-top:10px;border-bottom:2px solid gray;">
                <div style="width:600px;height:400px;background-image: url('/data/<?=$recipe_list[$r_cnt]['mr_comp_img']?>');background-size: contain;background-repeat: no-repeat;">
                </div>
