...
<fieldset id="sch_res_detail">
    ...
    <div class="sch_wr">
        ...
        <div class="sch_ipt">
        	...
        	<button type="submit" class="btn_sch_submit"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only">검색</span></button>
		</div>
         ...
         ?>
            ...
            <li>
            	<div class="sch_res_title">
                    ...
                    <a href="<?php echo $list[$idx][$i]['href'] ?>" target="_blank" class="sch_res_new"><i class="fa fa-share-square-o" aria-hidden="true"></i> 새창</a>
                </div>
