          ...
          <div class="carousel-item active" style="background-image: url('<?php echo G5_THEME_URL ?>/asset/images/slide/jetty.png')">
            <div class="carousel-caption">
              <h3>슬라이드 1의 헤드라인입니다.</h3>
                ...
                <span><a class="btn btn-outline-dark btn-sm" href="#" role="button">Learn More</a></span>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url('<?php echo G5_THEME_URL ?>/asset/images/slide/yellowstone-national-park.png')">
            <div class="carousel-caption">
              <h3>슬라이드 2의 헤드라인입니다.</h3>
                ...
                <span><a class="btn btn-outline-primary btn-sm" href="#" role="button">Our Process</a></span>
            </div>
          </div>
          ...
          <div class="carousel-item" style="background-image: url('<?php echo G5_THEME_URL ?>/asset/images/slide/boats.png')">
            <div class="carousel-caption">
              <h3>슬라이드 3의 헤드라인입니다.</h3>
                ...
                <span><a class="btn btn-outline-light btn-sm" href="#" role="button">Learn How</a></span>
            </div>
          </div>
        </div>
...
<!-- 콘텐츠 시작 { -->	
    <main role="main">
		...
		if(!defined('_INDEX_')) { // index가 아닌 경우에만 실행
		    if ($bo_table == "list" || $bo_table == "gallery" || $bo_table == "webzine") {
			    include_once(G5_THEME_PATH.'/paral/paral_01.php');
		    } else if ($co_id == "page1" || $co_id == "page2") {
				include_once(G5_THEME_PATH.'/paral/paral_02.php');
			} else if  ($co_id == "typo") {
				include_once(G5_THEME_PATH.'/paral/paral_03.php');
			} else {
				include_once(G5_THEME_PATH.'/paral/paral_04.php');
			}
		}
		 ?>
		<div class="container">
