...
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_JS_URL.'/owl.carousel.min.css">', 0);
...
if($this->total_count > 0) {
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        if ($this->href) {
            echo '<div class="sct_img"><a href="'.$this->href.$row['it_id'].'" class="sct_a"><span class="best_icon"><span>BEST</span></span>'.PHP_EOL;
        }
        ...
        echo "<div class=\"li_wr\"><div class=\"li_box\">\n";
