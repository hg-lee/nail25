...
<div id="sit_ov_wrap">
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        ...
        <div class="sit_ov_wr">
            ...
            <button type="button" class="sit_ov_btn">기본정보 <i class="fa fa-angle-down"></i></button>
        ...
        <script>
            $(function(){
                $(".sit_ov_btn").click(function(){
                    $(".sit_ov_tbl").toggle();
                    $(".sit_ov_btn i").toggleClass("fa-angle-down").toggleClass("fa-angle-up");
        ...
        <div class="sns_share">
            <button type="button" class="btn_sns_share"><i class="fa fa-share-alt" aria-hidden="true"></i> 공유 </button>
            <div class="sns_area">
...
<div id="sit_tab">
    <ul class="tab_tit">
        ...
        <li><button type="button" rel="#sit_use">사용후기<span class="sound_only">리뷰</span> <?php echo $it['it_use_cnt']; ?></button></li>
