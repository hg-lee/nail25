...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="cmt_contents">
            ...
            ?>
                <ul class="bo_vc_act">
                    <?php if ($list[$i]['is_reply']) { ?><li class="reply-btn"><a href="<?php echo $c_reply_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;">답변</a></li><?php } ?>
        ...
        <textarea id="save_comment_<?php echo $comment_id ?>" style="display:none" class="frm_text"><?php echo get_text($list[$i]['content1'], 0) ?></textarea>
...
<?php if ($is_comment_write) {
    ...
    <aside id="bo_vc_w">
        ...
        <?php if ($comment_min || $comment_max) { ?>onkeyup="check_byte('wr_content', 'char_count');"<?php } ?> placeholder="댓글내용을 입력해주세요" class="frm_text"><?php echo $c_wr_content; ?></textarea>
