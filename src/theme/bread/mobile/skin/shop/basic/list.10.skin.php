...
for ($i=0; $row=sql_fetch_array($result); $i++) {
    if ($i == 0) {
        if ($this->css) {
            ...
            echo "<ul id=\"sct_wrap\" class=\"sct_list sct ".$ul_sct_class."\">\n";
        }
    }
    ...
    echo "<div class=\"sct_cart_btn\">
            <button type=\"button\" class=\"btn_cart btn_b01\" data-it_id=\"{$row['it_id']}\"><i class=\"fa fa-shopping-cart\" aria-hidden=\"true\"></i> <span class=\"sound_only\">장바구니</span></button><button type=\"button\" class=\"btn_wish btn_b01\" data-it_id=\"{$row['it_id']}\"><span class=\"sound_only\">위시리스트</span><i class=\"fa fa-heart\" aria-hidden=\"true\"></i></button><button typd=\"button\" class=\"btn_share btn_b01\"><i class=\"fa fa-share-alt\" aria-hidden=\"true\"></i><span class=\"sound_only\">sns공유</span></button>\n";
