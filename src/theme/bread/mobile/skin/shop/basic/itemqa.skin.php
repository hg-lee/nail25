...
<div id="sit_qa_wbtn">
    <a href="<?php echo $itemqa_form; ?>" class="itemqa_form qa_wr btn_b02">문의작성<span class="sound_only"> 새 창</span></a>
    <a href="<?php echo $itemqa_list; ?>" id="itemqa_list" class="btn_b03">더보기</a>
</div>
<script>
$(function(){
