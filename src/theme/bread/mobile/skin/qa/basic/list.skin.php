...
<div id="bo_list">
    ...
    <ul class="btn_wr">
        <?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="btn btn_admin">관리자</a></li><?php } ?>
        <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn btn_b02"> 문의등록</a></li><?php } ?>
    </ul>
    <?php } ?>
