...
<div id="category">
    <button type="button" class="btn_close btn_b01"><i class="fa fa-times"></i></button>
    <?php echo outlogin('theme/shop_basic'); // 외부 로그인 ?>
    <div class="menu_wr">
        <ul class="cate_tab">
            <li><a href="#cate_01" class="selected">쇼핑몰</a></li>
            <li><a href="#cate_02">커뮤니티</a></li>
