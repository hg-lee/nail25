    ...
    <section id="anc_sidx_ord">
        ...
        <?if($mode=="m"){
            for($i=0;$i<$process_img_cnt;$i++){
                ...
                if($recipe_list['mr_complete']=='N') $btn_msg="저장";
                else $btn_msg="수정";
                ...
                <div class="recipe_work_wrap">
                    ...
                    <div class="recipe_work_contents">
                         ...
                         <div class="rep_exp">
                               <textarea class="rep_exp<?=($i+1)?>_txt" cols="50" rows="5" placeholder="설명을 입력하세요.." name="rep_exp<?=($i+1)?>_txt"><?=$recipe_list[$p_field_exp]?></textarea>
                        </div>
                    </div>
                </div>
            <?}?>
            ...
            <div style="width:100%;margin-top:10px;text-align: center;">
                <div style="left:50%;">
                    ...
                    <button style="width:180px;height:50px;line-height: 50px;font-size:18px;" onClick='on_work(2);return false;'><?=$btn_msg?></button>
                </div>
            </div>
        <?}else{?>
        <div class="recipe_work_wrap">
