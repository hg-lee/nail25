...
<div class="local_sch03 local_sch">
    ...
    <div>
        <form name="frm_sale_today" action="./reserve_today.php" method="get">
        <strong>일일 예약</strong>
    ...
    <div>
        <form name="frm_sale_date" action="./reserve_date.php" method="get">
        <strong>일간 예약</strong>
    ...
    <div>
        <form name="frm_sale_month" action="./reserve_month.php" method="get">
        <strong>월간 예약</strong>
    ...
    <div class="sch_last">
        <form name="frm_sale_year" action="./reserve_year.php" method="get">
        <strong>연간 예약</strong>
