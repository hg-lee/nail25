...
include_once (G5_ADMIN_PATH.'/admin.partnercenter.head.php');
        ...
        <div id="sidx_graph">
            ...
            <ul id="sidx_graph_area">
                ...
                for($i=0; $i<count($x_val); $i++) {
                    $order_title = date("n월 j일", strtotime($x_val[$i])).' 예약: '.display_price($arr_order[$i]['order']);
    ...
    <div id="sidx_stat">
        <section id="anc_sidx_act">
            ...
            <div id="sidx_take_act" class="tbl_head01 tbl_wrap">
                ...
                <tr>
                    <?php
                    $info = get_order_status_sum('예약');
                    ?>
                    <th scope="row">예약 -&gt; 입금</th>
                ...
                <tr>
                    <?php
                    $info = get_order_status_sum('시술');
                    ?>
                    <th scope="row">시술 -&gt; 완료</th>
                    <td class="td_num"><a href="<?php echo $info['href']; ?>"><?php echo number_format($info['count']); ?></a></td>
                    <td class="td_price"><a href="<?php echo $info['href']; ?>"><?php echo number_format($info['price']); ?></a></td>
                </tr>
                </tbody>
