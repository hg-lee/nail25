			...
			<tbody>
				<tr style="text-align:center;">
					<td colspan="2">
						<div style="width:90%">
							<div style="width:90%;float:left;">
								<div style="width:100%;text-align: center;height:200px;border:1px solid black;;">
									<?=$shop_note?>
								</div>
								<div style="width:100%;float:left;padding:10px;text-align:center;">
					...
					<td colspan="2">
						<div style="width:90%">
							<div style="width:90%;float:left;">
								...
								<div style="width:100%;float:left;padding:10px;text-align:center;">
									<button class="btn_frmline reg_btn2" style="margin-bottom:10px;">네일 레시피 <?=$btn_msg?></button>
								</div>
							</div>
						</div>
					</td>
